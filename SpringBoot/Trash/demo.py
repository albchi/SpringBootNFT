...
layout = [[sg.Text("Hello from PySimpleGUI")], 
    ...
    [sg.Button("Ping VMware Blockchain local Minikube")],
...
# Create the window
window = sg.Window("VMware Blockchain NFT Demo", layout)
...
while True:
    ...
    if event == "Ping VMware Blockchain local Minikube":
        r = requests.get('http://192.168.59.107:8545')
        print (r.json())
